package com.awesomeshot5051.plantfarms.entity;
...
public class EasyVillagerEntity extends Villager {
    ...
    public Component getAdvancedName() {
        return Component.translatable("tooltip.plant_farms.villager_profession", getName().copy(), Component.translatable("merchant.level." + getVillagerData().getLevel())).withStyle(ChatFormatting.GRAY);
    }
