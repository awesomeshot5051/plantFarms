...
public class ModBlocks {    /*     * Custom Water Block For Plant Farm display ONLY     *     * */
    ...
    public static final DeferredHolder<Block, azureFarmBlock> AZURE_FARM = BLOCK_REGISTER.register("azure_farm", azureFarmBlock::new);
    public static final DeferredHolder<Block, redFarmBlock> RED_FARM = BLOCK_REGISTER.register("red_farm", redFarmBlock::new);
    public static final DeferredHolder<Block, orangeFarmBlock> ORANGE_FARM = BLOCK_REGISTER.register("orange_farm", orangeFarmBlock::new);
    public static final DeferredHolder<Block, whiteFarmBlock> WHITE_FARM = BLOCK_REGISTER.register("white_farm", whiteFarmBlock::new);
    public static final DeferredHolder<Block, pinkFarmBlock> PINK_FARM = BLOCK_REGISTER.register("pink_farm", pinkFarmBlock::new);
    public static final DeferredHolder<Block, daisyFarmBlock> DAISY_FARM = BLOCK_REGISTER.register("daisy_farm", daisyFarmBlock::new);
    ...
    public static final DeferredHolder<Block, lilyFarmBlock> LILY_FARM = BLOCK_REGISTER.register("lily_farm", lilyFarmBlock::new);
    ...
    public static final DeferredHolder<Block, roseFarmBlock> ROSE_FARM = BLOCK_REGISTER.register("rose_farm", roseFarmBlock::new);
