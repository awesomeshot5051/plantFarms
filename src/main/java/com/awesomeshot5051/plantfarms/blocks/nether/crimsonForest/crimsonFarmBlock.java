...
public class crimsonFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    ...
    protected ItemInteractionResult useItemOn(ItemStack heldItem, BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (!(tileEntity instanceof crimsonFarmTileentity farm)) { // Check for crimsonFarmTileentity.java
        ...
        player.openMenu(new MenuProvider() {
            ...
            public AbstractContainerMenu createMenu(int id, Inventory playerInventory, Player player) {
                return new OutputContainer(id, playerInventory, farm.getOutputInventory(), ContainerLevelAccess.create(worldIn, pos), ModBlocks.CRIMSON_FARM::get); // Adjust for acacia farm
            }
        });
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new crimsonFarmTileentity(blockPos, blockState); // Spawn crimsonFarmTileentity.java
    }
