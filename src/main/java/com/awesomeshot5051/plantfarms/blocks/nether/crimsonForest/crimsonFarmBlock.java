package com.awesomeshot5051.plantfarms.blocks.nether.crimsonForest;
...
import com.awesomeshot5051.plantfarms.items.render.nether.crimsonForest.*;
...
public class crimsonFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    ...
    public Item toItem() {
        return new CustomRendererBlockItem(this, new Item.Properties()) {
            ...
            public ItemRenderer createItemRenderer() {
                return new crimsonFarmItemRenderer();
            }
        };
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext tooltipContext, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown()) {
            components.add(Component.translatable("tooltip.plantfarms.crimson_farm.shift").withStyle(ChatFormatting.GRAY));
            ...
            components.add(Component.translatable("tooltip.plantfarms.crimson_farm.hint").withStyle(ChatFormatting.YELLOW));
        }
    }
    ...
    protected ItemInteractionResult useItemOn(ItemStack heldItem, BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (!(tileEntity instanceof crimsonFarmTileentity farm)) {
        ...
        player.openMenu(new MenuProvider() {
            ...
            public AbstractContainerMenu createMenu(int id, Inventory playerInventory, Player player) {
                return new OutputContainer(id, playerInventory, farm.getOutputInventory(), ContainerLevelAccess.create(worldIn, pos), ModBlocks.CRIMSON_FARM::get);
            }
        });
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new crimsonFarmTileentity(blockPos, blockState);
    }
