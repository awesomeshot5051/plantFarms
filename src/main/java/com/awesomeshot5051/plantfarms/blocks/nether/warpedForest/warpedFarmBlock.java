package com.awesomeshot5051.plantfarms.blocks.nether.warpedForest;
...
import com.awesomeshot5051.plantfarms.items.render.nether.warpedForest.*;
...
public class warpedFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    ...
    public Item toItem() {
        return new CustomRendererBlockItem(this, new Item.Properties()) {
            ...
            public ItemRenderer createItemRenderer() {
                return new warpedFarmItemRenderer();
            }
        };
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown()) {
            components.add(Component.translatable("tooltip.plantfarms.warped_farm.shift").withStyle(ChatFormatting.GRAY));
            ...
            components.add(Component.translatable("tooltip.plantfarms.warped_farm.hint").withStyle(ChatFormatting.YELLOW));
        }
    }
    ...
    protected ItemInteractionResult useItemOn(ItemStack heldItem, BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (!(tileEntity instanceof warpedFarmTileentity farm)) {
        ...
        player.openMenu(new MenuProvider() {
            ...
            public AbstractContainerMenu createMenu(int id, Inventory playerInventory, Player player) {
                return new OutputContainer(id, playerInventory, farm.getOutputInventory(), ContainerLevelAccess.create(worldIn, pos), ModBlocks.WARPED_FARM::get);
            }
        });
    ...
    public void setPlacedBy(Level level, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (blockEntity instanceof warpedFarmTileentity farmTileEntity) {
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new warpedFarmTileentity(blockPos, blockState);
    }
