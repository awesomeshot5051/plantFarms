...
public class bambooFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    public bambooFarmBlock() {
    ...
    public Item toItem() {
        return new CustomRendererBlockItem(this, new Item.Properties()) {
            ...
            public ItemRenderer createItemRenderer() {
                return new bambooFarmItemRenderer();
            }
        };
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        bambooFarmTileentity trader = VillagerBlockEntityData.getAndStoreBlockEntity(stack, context.registries(), context.level(), () -> new bambooFarmTileentity(BlockPos.ZERO, ModBlocks.BAMBOO_FARM.get().defaultBlockState()));
        if (Screen.hasShiftDown()) {
            ...
            components.add(Component.literal("This farm has a " + convertToReadableName(axeType.getItem().getDefaultInstance().getDescriptionId()) + " on it.").withStyle(ChatFormatting.RED));
        } else {
    ...
    protected ItemInteractionResult useItemOn(ItemStack heldItem, BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        if (!(tileEntity instanceof bambooFarmTileentity farm)) {
        ...
        player.openMenu(new MenuProvider() {
            ...
            public AbstractContainerMenu createMenu(int id, Inventory playerInventory, Player player) {
                return new OutputContainer(id, playerInventory, farm.getOutputInventory(), ContainerLevelAccess.create(worldIn, pos), ModBlocks.BAMBOO_FARM::get);
            }
        });
    ...
    public void setPlacedBy(Level level, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (blockEntity instanceof bambooFarmTileentity farmTileEntity) {
            ItemContainerContents axeType = stack.get(ModDataComponents.HOE_TYPE);
            if (axeType != null) {
    ...
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new bambooFarmTileentity(blockPos, blockState);
    }
