...
public class MangroveFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    // private static final ResourceKey<LootTable> MANGROVE_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/mangrove"));
    ...
    public static double getMangroveSpawnTime(MangroveFarmTileentity farm) {
        ...
        return (double) Main.SERVER_CONFIG.mangroveSpawnTime.get() /
    ...
    public static double getMangroveDeathTime(MangroveFarmTileentity farm) {
        ...
        return getMangroveSpawnTime(farm) + (axe.equals(AxeType.NETHERITE) ? (baseValue * 3.2) :
...
//        BlockBase.playRandomVillagerSound(level, getBlockPos(), SoundEvents.MANGROVE_PRIMED);
...
//            // VillagerBlockBase.playVillagerSound(level, getBlockPos(), SoundEvents.MANGROVE_DEATH);
    ...
    private List<ItemStack> getDrops() {
        ...
        if (serverWorld.random.nextDouble() < dropChance) {
            ...
            drops.add(new ItemStack(Items.MANGROVE_ROOTS, dropCount)); // Drop 1 blaze rod
        }
