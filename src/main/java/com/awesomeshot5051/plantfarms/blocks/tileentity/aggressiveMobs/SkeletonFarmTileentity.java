...
//            // VillagerBlockBase.playVillagerSound(level, getBlockPos(), SoundEvents.SKELETON_DEATH);
    ...
    private List<ItemStack> getDrops() {
        ...
        LootParams.Builder builder = new LootParams.Builder(serverWorld)
                .withParameter(LootContextParams.THIS_ENTITY, new Skeleton(EntityType.SKELETON, level))
        ...
        LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(SKELETON_LOOT_TABLE);
