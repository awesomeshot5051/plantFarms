...
public class SquidFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public SquidFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.SQUID_FARM.get(), ModBlocks.SQUID_FARM.get().defaultBlockState(), pos, state);
...
//            }
    ...
    private List<ItemStack> getDrops() {
        ...
        LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(SQUID_LOOT_TABLE);
