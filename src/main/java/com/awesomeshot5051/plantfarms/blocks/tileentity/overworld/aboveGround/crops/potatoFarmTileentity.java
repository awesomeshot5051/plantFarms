...
//private static final ResourceKey<LootTable> POTATO_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/potato"));
    ...
    public static double getPotatoSpawnTime(potatoFarmTileentity farm) {
        ...
        return (double) Main.SERVER_CONFIG.potatoSpawnTime.get() /
    ...
    public static double getPotatoDeathTime(potatoFarmTileentity farm) {
        ...
        return getPotatoSpawnTime(farm) + (hoe.equals(HoeType.NETHERITE) ? (baseValue * 3.2) :
...
//        BlockBase.playRandomVillagerSound(level, getBlockPos(), SoundEvents.POTATO_PRIMED);
    ...
    private List<ItemStack> getDrops() {
        ...
        if (serverWorld.random.nextDouble() < dropChance) {
            ...
            drops.add(new ItemStack(Items.POISONOUS_POTATO, dropCount)); // Drop 1 blaze rod
        }
