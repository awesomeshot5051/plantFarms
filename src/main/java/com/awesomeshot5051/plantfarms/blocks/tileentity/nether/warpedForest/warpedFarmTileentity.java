...
//private static final ResourceKey<LootTable> ACACIA_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/acacia"));
    ...
    public static int getWarpedSpawnTime() {
        return Main.SERVER_CONFIG.warpedSpawnTime.get() - 20 * 4;
    }

    public static int getWarpedDeathTime() {
        return getWarpedSpawnTime() + 20 * 4; // 30 seconds spawn time + 10 seconds kill time
    }
