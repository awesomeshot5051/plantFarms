...
//private static final ResourceKey<LootTable> MELON_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/melon"));
    ...
    public static int getMelonSpawnTime() {
        return Main.SERVER_CONFIG.melonSpawnTime.get() - 20 * 4;
    }

    public static int getMelonDeathTime() {
        return getMelonSpawnTime() + 20 * 4; // 30 seconds spawn time + 10 seconds kill time
    }
...
//            }
        } else if (timer >= getMelonDeathTime()) {
