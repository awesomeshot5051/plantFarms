...
//            // VillagerBlockBase.playVillagerSound(level, getBlockPos(), SoundEvents.ZOGLIN_DEATH);
    ...
    private List<ItemStack> getDrops() {
        ...
        LootParams.Builder builder = new LootParams.Builder(serverWorld)
                .withParameter(LootContextParams.THIS_ENTITY, new Zoglin(EntityType.ZOGLIN, level))
        ...
        LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(ZOGLIN_LOOT_TABLE);
