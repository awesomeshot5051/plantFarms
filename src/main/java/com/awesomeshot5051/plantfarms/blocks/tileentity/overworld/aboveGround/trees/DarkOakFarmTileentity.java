...
public class DarkOakFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public DarkOakFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.DARK_OAK_FARM.get(), ModBlocks.DARK_OAK_FARM.get().defaultBlockState(), pos, state);
    ...
    public static double getDarkOakSpawnTime(DarkOakFarmTileentity farm) {
        ...
        return (double) Main.SERVER_CONFIG.darkOakSpawnTime.get() / (axe.equals(AxeType.NETHERITE) ? 30 : axe.equals(AxeType.DIAMOND) ? 25 : axe.equals(AxeType.GOLDEN) ? 20 : axe.equals(AxeType.IRON) ? 15 : axe.equals(AxeType.STONE) ? 10 : 1);
    }
    ...
    public static double getDarkOakDeathTime(DarkOakFarmTileentity farm) {
        ...
        return getDarkOakSpawnTime(farm) + (axe.equals(AxeType.NETHERITE) ? (baseValue * 3.2) : axe.equals(AxeType.DIAMOND) ? (baseValue * 5.6) : axe.equals(AxeType.IRON) ? (baseValue * 4.8) : axe.equals(AxeType.STONE) ? (baseValue * 6.4) : axe.equals(AxeType.WOODEN) ? (baseValue * 6.4) : 6.4);
    }
    ...
    private List<ItemStack> getDrops() {
        ...
        if (serverWorld.random.nextDouble() < dropChance) {
            ...
            drops.add(new ItemStack(Items.DARK_OAK_SAPLING, dropCount));
            drops.add(new ItemStack(Items.APPLE));
        }
        drops.add(new ItemStack(Items.DARK_OAK_LOG));
        if (serverWorld.random.nextDouble() < .005) {
            drops.add(new ItemStack(Items.STRIPPED_DARK_OAK_LOG));
        }
        drops.add(new ItemStack(Items.DARK_OAK_LEAVES));
        return drops;
    }
