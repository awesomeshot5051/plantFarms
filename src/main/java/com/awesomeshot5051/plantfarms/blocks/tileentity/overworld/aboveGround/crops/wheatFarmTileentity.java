...
public class wheatFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {

//private static final ResourceKey<LootTable> WHEAT_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/wheat"));
    ...
    public wheatFarmTileentity(BlockPos pos, BlockState state) {
        super(ModTileEntities.WHEAT_FARM.get(), ModBlocks.WHEAT_FARM.get().defaultBlockState(), pos, state);
    ...
    private List<ItemStack> getDrops() {
        ...
        if (serverWorld.random.nextDouble() < dropChance) {
            ...
            drops.add(new ItemStack(Items.WHEAT_SEEDS, dropCount)); // Drop 1 blaze rod
        }

        drops.add(new ItemStack(Items.WHEAT));
