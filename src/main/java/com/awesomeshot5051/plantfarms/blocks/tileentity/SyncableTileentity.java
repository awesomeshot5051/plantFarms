...
public class SyncableTileentity extends BlockEntity {
    ...
    public static Map<ResourceKey<Enchantment>, Boolean> loadHoeEnchantments(CompoundTag compound, HolderLookup.Provider provider, VillagerTileentity farm) {
    ...
    public static Map<ResourceKey<Enchantment>, Boolean> loadAxeEnchantments(CompoundTag compound, HolderLookup.Provider provider, VillagerTileentity farm) {
