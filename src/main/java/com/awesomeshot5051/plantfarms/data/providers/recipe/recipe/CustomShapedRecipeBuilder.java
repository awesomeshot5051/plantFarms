...
public class CustomShapedRecipeBuilder implements RecipeBuilder {
    ...
    public void save(RecipeOutput recipeOutput, @NotNull ResourceLocation id) {
        ...
        CustomShapedRecipe shapedrecipe = new CustomShapedRecipe(Objects.requireNonNullElse(this.group, ""), RecipeBuilder.determineBookCategory(this.category), shapedrecipepattern, this.resultStack, showNotification);
