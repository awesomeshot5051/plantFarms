    ...
    protected void buildRecipes(@NotNull RecipeOutput recipeOutput) {
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, OAK_FARM.get())
                ...
                .save((recipeOutput), ResourceLocation.fromNamespaceAndPath(Main.MODID,
                        convertToRegistryName(OAK_FARM.get().getDescriptionId() + "_recipe")));
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, BIRCH_FARM.get()).pattern("###")
                .pattern("#A#")
                .pattern("#O#")
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, SPRUCE_FARM.get()).pattern("###")
                .pattern("#A#")
                .pattern("#O#")
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, JUNGLE_FARM.get()).pattern("###")
                .pattern("#A#")
                .pattern("#O#")
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, ACACIA_FARM.get()).pattern("###")
                .pattern("#A#")
                .pattern("#O#")
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, DARK_OAK_FARM.get()).pattern("###")
                .pattern("#A#")
                .pattern("#O#")
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, MANGROVE_FARM.get()).pattern("###")
                .pattern("#A#")
                .pattern("#O#")
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, CHERRY_FARM.get()).pattern("###")
                .pattern("#A#")
                .pattern("#O#")
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, CGRASS_FARM.get()).pattern("###")
                .pattern("#W#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, KELP_FARM.get()).pattern("###")
                .pattern("#W#")
                .pattern("#K#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('W', Items.WATER_BUCKET)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, LEAF_FARM.get()).pattern("###")
                .pattern("#W#")
                .pattern("#L#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('W', Items.WATER_BUCKET)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, PAD_FARM.get()).pattern("###")
                .pattern("#W#")
                .pattern("#P#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('W', Items.WATER_BUCKET)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, DANDELION_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, POPPY_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, ORCHID_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, ALLIUM_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, AZURE_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, RED_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, ORANGE_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, PINK_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, DAISY_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, CORNFLOWER_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, LILY_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, SUNFLOWER_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, LILAC_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, ROSE_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, PEONY_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHEAT_FARM.get()).pattern("###")
                .pattern("#H#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, CARROT_FARM.get()).pattern("###")
                .pattern("#H#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('H', ItemTags.HOES)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, GCARROT_FARM.get()).pattern("###")
                .pattern("#F#")
                .pattern("###")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, FARM_BLOCK.get()).pattern("###")
                .pattern("#W#")
                .pattern("#D#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('D', Items.DIRT)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, POTATO_FARM.get()).pattern("###")
                .pattern("#H#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('H', ItemTags.HOES)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, BEETROOT_FARM.get()).pattern("###")
                .pattern("#H#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('H', ItemTags.HOES)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, PUMPKIN_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, MELON_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', ItemTags.HOES)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, SUGAR_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, COCO_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', Items.BONE_MEAL)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, BERRY_FARM.get()).pattern("###")
                .pattern("#B#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('B', ItemTags.HOES)
        ...
        CustomShapedRecipeBuilder.shaped(RecipeCategory.MISC, BAMBOO_FARM.get()).pattern("###")
                .pattern("#A#")
                .pattern("#C#")
                .define('#', Tags.Items.GLASS_PANES)
                .define('A', ItemTags.AXES)
