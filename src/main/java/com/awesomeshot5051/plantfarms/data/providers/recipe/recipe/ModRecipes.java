...
public class ModRecipes {
    ...
    public static final Supplier<RecipeSerializer<CustomShapedRecipe>> SHAPED_SERIALIZER =
            RECIPE_SERIALIZERS.register("shaped_serializer", CustomShapedRecipe.Serializer::new);
    ...
    public static final Supplier<RecipeSerializer<TFarmBlockRecipe>> TFARM_SERIALIZER =
            RECIPE_SERIALIZERS.register("tfarm_serializer", TFarmBlockRecipe.Serializer::new);
    ...
    public static final Supplier<RecipeType<CustomShapedRecipe>> FARM_RECIPE =
    ...
    public static final Supplier<RecipeType<EnchantmentAdditionRecipe>> ENCHANTING_RECIPE =
            RECIPE_TYPES.register(
                    "enchanting_recipe",
                    () -> RecipeType.simple(ResourceLocation.fromNamespaceAndPath(Main.MODID, "enchanting_recipe")));
