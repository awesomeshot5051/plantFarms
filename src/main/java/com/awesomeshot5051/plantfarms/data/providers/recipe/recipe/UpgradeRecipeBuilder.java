...
public class UpgradeRecipeBuilder implements RecipeBuilder {
    ...
    public void save(RecipeOutput recipeOutput, @NotNull ResourceLocation id) {
        ...
        UpgradeRecipe shapedrecipe = new UpgradeRecipe(Objects.requireNonNullElse(this.group, ""), RecipeBuilder.determineBookCategory(this.category), shapedrecipepattern, this.resultStack, showNotification);
