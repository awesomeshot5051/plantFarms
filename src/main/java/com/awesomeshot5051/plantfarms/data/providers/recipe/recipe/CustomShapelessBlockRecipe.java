...
public class CustomShapelessBlockRecipe extends ShapelessRecipe {
    ...
    public ItemStack assemble(CraftingInput input, HolderLookup.Provider registries) {
        ...
        ItemStack resultItem = new ItemStack(Items.AIR);
        ItemContainerContents hoeContents = null;
        List<ItemStack> logDroppers = List.of(new ItemStack(Items.ACACIA_SAPLING), new ItemStack(Items.BIRCH_SAPLING), new ItemStack(Items.DARK_OAK_SAPLING), new ItemStack(Items.JUNGLE_SAPLING), new ItemStack(Items.MANGROVE_PROPAGULE), new ItemStack(Items.OAK_SAPLING), new ItemStack(Items.SPRUCE_SAPLING), new ItemStack(Items.CRIMSON_FUNGUS), new ItemStack(Items.WARPED_FUNGUS), new ItemStack(Items.CHERRY_SAPLING));
        List<ItemStack> crops = List.of(new ItemStack(Items.BEETROOT), new ItemStack(Items.CARROT), new ItemStack(Items.MELON_SLICE), new ItemStack(Items.WHEAT), new ItemStack(Items.POTATO), new ItemStack(ModItems.TFARM_BLOCK), new ItemStack(Items.PUMPKIN));
        List<ItemStack> others = List.of(new ItemStack(Items.AZALEA), new ItemStack(Items.SWEET_BERRIES), new ItemStack(Items.SEAGRASS), new ItemStack(Items.CHORUS_FLOWER), new ItemStack(Items.CHORUS_FRUIT), new ItemStack(Items.KELP), new ItemStack(Items.BROWN_MUSHROOM), new ItemStack(Items.LILY_PAD), new ItemStack(Items.VINE), new ItemStack(Items.SUNFLOWER), new ItemStack(Items.LILAC), new ItemStack(Items.ROSE_BUSH), new ItemStack(Items.PEONY), new ItemStack(Items.DANDELION), new ItemStack(Items.POPPY), new ItemStack(Items.BLUE_ORCHID), new ItemStack(Items.ALLIUM), new ItemStack(Items.AZURE_BLUET), new ItemStack(Items.RED_TULIP), new ItemStack(Items.ORANGE_TULIP), new ItemStack(Items.WHITE_TULIP), new ItemStack(Items.PINK_TULIP), new ItemStack(Items.OXEYE_DAISY), new ItemStack(Items.CORNFLOWER), new ItemStack(Items.LILY_OF_THE_VALLEY), new ItemStack(Items.COCOA_BEANS), new ItemStack(Items.SUGAR_CANE));
    ...
    private ItemStack hoeRecipe(List<ItemStack> ingredients) {
        ...
        tfarm = ingredients.stream().filter(ingredient -> ingredient.equals(tfarm)).findFirst().orElse(tfarm);
