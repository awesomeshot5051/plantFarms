...
//private static final ResourceKey<LootTable> BAMBOO_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/bamboo"));
    ...
    public static int getBambooSpawnTime() {
        return Main.SERVER_CONFIG.bambooSpawnTime.get() - 20 * 4;
    }

    public static int getBambooDeathTime() {
        return getBambooSpawnTime() + 20 * 4; // 30 seconds spawn time + 10 seconds kill time
    }
...
//            }
        } else if (timer >= getBambooDeathTime()) {
